(function () {
  ...
  function createCard(label)
  {
    ...
    myRect.setAttributeNS(null,"id","myRect");
    ...
    myRect.setAttributeNS(null,"fill","yellow");
    myRect.setAttributeNS(null,"stroke","black");

    document.getElementById("myCard").appendChild(myRect);

    var myText = document.createElementNS(svgNS,"text");
    myText.setAttributeNS(null,"id","myText");
    myText.setAttributeNS(null,"x",20);
    myText.setAttributeNS(null,"y",25);
    myText.setAttributeNS(null,"fill","grey");
    myText.textContent="DS";

    document.getElementById("myCard").appendChild(myText);

    var myLabel = document.createElementNS(svgNS,"text");
    myLabel.setAttributeNS(null,"id","myLabel");
    myLabel.setAttributeNS(null,"x",20);
    myLabel.setAttributeNS(null,"y",40);
    myLabel.textContent=label;

    document.getElementById("myCard").appendChild(myLabel);
  }     

  var db = new PouchDB('todos');
  var remoteCouch = 'http://129.16.56.39:5984/todos';
